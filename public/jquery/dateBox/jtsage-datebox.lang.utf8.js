...
jQuery.extend(jQuery.jtsage.datebox.prototype.options.lang, {
	"af": {
		...
		"calHeaderFormat": "%B %Y",
		"tomorrowButtonLabel": "Spring na MÃ´re"
	},
	"ar": {
		"setDateButtonLabel": "ØªØ¹ÙŠÙŠÙ† ØªØ§Ø±ÙŠØ®",
		"setTimeButtonLabel": "Ø¶Ø¨Ø· Ø§Ù„ÙˆÙ‚Øª",
		"setDurationButtonLabel": "ØªØ¹ÙŠÙŠÙ† Ø§Ù„Ù…Ø¯Ø©",
		"todayButtonLabel": "Ø§Ù„Ù‚ÙØ² Ø¥Ù„Ù‰ Ø§Ù„ÙŠÙˆÙ…",
		"titleDateDialogLabel": "Ø§Ø®ØªØ± Ø§Ù„ØªØ§Ø±ÙŠØ®",
		...
		"tooltip": "ÙØªØ­ Ù…Ù†ØªÙ‚ÙŠ Ø§Ù„ØªØ§Ø±ÙŠØ®",
		"nextMonth": "Ø§Ù„ØªØ§Ù„ÙŠ",
		...
		"timeOutput": "%l:%M %p",
		"durationFormat": "%Dd %DA, %Dl:%DM:%DS",
		"calDateListLabel": "ØªÙˆØ§Ø±ÙŠØ® Ø£Ø®Ø±Ù‰",
		"calHeaderFormat": "%B %Y",
		"tomorrowButtonLabel": "Ø§Ù„Ù‚ÙØ² Ø¥Ù„Ù‰ Ø§Ù„ØºØ¯"
	},
	"bg": {
		"setDateButtonLabel": "Ð—Ð°Ð¿Ð°Ð·Ð¸ Ð”Ð°Ñ‚Ð°Ñ‚Ð°",
		"setTimeButtonLabel": "Ð—Ð°Ð¿Ð°Ð·Ð¸ Ð§Ð°ÑÑŠÑ‚",
		"setDurationButtonLabel": "Ð—Ð°Ð¿Ð°Ð·Ð¸ Ð’Ñ€ÐµÐ¼ÐµÑ‚Ð¾",
		"todayButtonLabel": "ÐžÐ±Ñ€Ð°Ñ‚Ð½Ð¾ Ð´Ð¾ Ð”Ð½ÐµÑ",
		...
		"tooltip": "Ð—Ð°Ñ€ÐµÐ´ÐµÑ‚Ðµ ÐŸÑ€Ð¾Ð·Ð¾Ñ€ÐµÑ†Ð° Ð·Ð° Ð”Ð°Ñ‚Ð°",
		"nextMonth": "Ð¡Ð»ÐµÐ´Ð²Ð°Ñ‰ ÐœÐµÑÐµÑ†",
		"prevMonth": "ÐŸÑ€ÐµÐ´Ð¸ÑˆÐµÐ½ ÐœÐµÑÐµÑ†",
		"timeFormat": 24,
		"headerFormat": "%A, %B %-d, %Y",
		"dateFieldOrder": [
			"d",
		...
		"timeOutput": "%l:%M %p",
		"durationFormat": "%Dd %DA, %Dl:%DM:%DS",
		"calDateListLabel": "Ð”Ñ€ÑƒÐ³Ð¸ Ð´Ð°Ñ‚Ð¸",
		"calHeaderFormat": "%B %Y",
		"tomorrowButtonLabel": "ÐÐ°Ð¿Ñ€Ð°Ð²Ð¾ ÐºÑŠÐ¼ ÑƒÑ‚Ñ€Ðµ"
	},
	"ca": {
		"setDateButtonLabel": "Tanca",
		"setTimeButtonLabel": "Tanca",
		"setDurationButtonLabel": "Tanca",
		"todayButtonLabel": "VÃ©s a avui",
	...
	"el": {
		"setDateButtonLabel": "ÎšÎ±Î¸Î¿ÏÎ¹ÏƒÎ¼ÏŒÏ‚ Î—Î¼ÎµÏÎ¿Î¼Î·Î½Î¯Î±Ï‚",
		"setTimeButtonLabel": "ÎšÎ±Î¸Î¿ÏÎ¹ÏƒÎ¼ÏŒÏ‚ ÎÏÎ±Ï‚",
		"setDurationButtonLabel": "ÎšÎ±Î¸Î¿ÏÎ¹ÏƒÎ¼ÏŒÏ‚ Î”Î¹Î¬ÏÎºÎµÎ¹Î±Ï‚",
		"todayButtonLabel": "ÎœÎµÏ„Î¬Î²Î±ÏƒÎ· ÏƒÏ„Î· ÏƒÎ·Î¼ÎµÏÎ¹Î½Î®",
		"titleDateDialogLabel": "Î•Ï€Î¹Î»Î­Î¾Ï„Îµ Î·Î¼ÎµÏÎ¿Î¼Î·Î½Î¯Î±",
		"titleTimeDialogLabel": "Î•Ï€Î¹Î»Î­Î¾Ï„Îµ Ï„Î·Î½ ÏŽÏÎ±",
		"daysOfWeek": [
			"ÎšÏ…ÏÎ¹Î±ÎºÎ®",
			"Î”ÎµÏ…Ï„Î­ÏÎ±",
			"Î¤ÏÎ¯Ï„Î·",
		...
		"calHeaderFormat": "%B %Y",
		"tomorrowButtonLabel": "Î†Î»Î¼Î± ÏƒÏ„Î¿ Î±ÏÏÎ¹Î¿"
	},
	"en": {
	...
	"fr": {
		...
		"todayButtonLabel": "Aller Ã  aujourd'hui",
		...
		"calHeaderFormat": "%B %Y",
		"tomorrowButtonLabel": "Aller Ã  demain"
	},
	"he": {
		"setDateButtonLabel": "×§×‘×¢ ×ª××¨×™×š",
		"setTimeButtonLabel": "×§×‘×¢ ×–×ž×Ÿ",
		"setDurationButtonLabel": "×§×‘×¢ ×ž×©×š ×–×ž×Ÿ",
		"todayButtonLabel": "ï»¿×§×¤×™×¦×” ××œ ×”×™×•×",
		"titleDateDialogLabel": "×‘×—×¨ ×ª××¨×™×š",
		"titleTimeDialogLabel": "×‘×—×¨ ×–×ž×Ÿ",
		"daysOfWeek": [
			"×¨××©×•×Ÿ",
			"×©× ×™",
			"×©×œ×™×©×™",
	...
	"hu": {
		...
		"calHeaderFormat": "%B %Y",
		"tomorrowButtonLabel": "UgrÃ¡s a holnap"
	},
	"id": {
	...
	"ja": {
		"setDateButtonLabel": "æ—¥ä»˜ã‚’è¨­å®š",
		"setTimeButtonLabel": "æ™‚åˆ»ã‚’è¨­å®š",
		"setDurationButtonLabel": "æœŸé–“ã‚’è¨­å®š",
		"todayButtonLabel": "ä»Šæ—¥ã¸ã‚¸ãƒ£ãƒ³ãƒ—",
		"titleDateDialogLabel": "æ—¥ä»˜ã‚’é¸æŠžã—ã¾ã™ã€‚",
		"titleTimeDialogLabel": "æ™‚é–“ã‚’é¸æŠžã—ã¾ã™ã€‚",
		"daysOfWeek": [
			"æ—¥æ›œ",
			"æœˆæ›œ",
			"ç«æ›œ",
		...
		"calHeaderFormat": "%B %Y",
		"tomorrowButtonLabel": "æ˜Žæ—¥ã¸ã‚¸ãƒ£ãƒ³ãƒ—ã—ã¾ã™ã€‚"
	},
	"ko": {
		"setDateButtonLabel": "ë‚ ì§œ ì§€ì •",
		"setTimeButtonLabel": "ì‹œê°„ ì„¤ì •",
		"setDurationButtonLabel": "ê¸°ê°„ ì„¤ì •",
		"todayButtonLabel": "ì˜¤ëŠ˜ ë‚ ì§œë¡œ ì§€ì •",
		"titleDateDialogLabel": "ë‚ ì§œ ì„ íƒ",
		"titleTimeDialogLabel": "ì‹œê°„ ì„ íƒ",
		"daysOfWeek": [
			"ì¼ìš”ì¼",
			"ì›”ìš”ì¼",
			"í™”ìš”ì¼",
		...
		"timeOutput": "%l:%M %p",
		"durationFormat": "%Dd %DA, %Dl:%DM:%DS",
		"calDateListLabel": "ë‹¤ë¥¸ ë‚ ì§œ",
		"calHeaderFormat": "%B %Y",
		"tomorrowButtonLabel": "ë‚´ì¼ ì´ë™"
	},
	"lt": {
		"setDateButtonLabel": "Data",
		"setTimeButtonLabel": "Laikas",
		"setDurationButtonLabel": "TrukmÄ—",
		"todayButtonLabel": "Å iandiena",
		...
		"calHeaderFormat": "%B %Y",
		"tomorrowButtonLabel": "PerÅ¡okti Ä¯ rytoj"
	},
	"nl-BE": {
	...
	"no": {
		...
		"todayButtonLabel": "GÃ¥ til dagens dato",
	...
	"ro": {
		...
		"tooltip": "Deschide selectorul de datÄƒ",
	...
	"ru": {
		"setDateButtonLabel": "Ð£ÑÑ‚Ð°Ð½Ð¾Ð²Ð¸Ñ‚ÑŒ Ð”Ð°Ñ‚Ñƒ",
		"setTimeButtonLabel": "Ð£ÑÑ‚Ð°Ð½Ð¾Ð²Ð¸Ñ‚ÑŒ Ð’Ñ€ÐµÐ¼Ñ",
		"setDurationButtonLabel": "Ð£ÑÑ‚Ð°Ð½Ð¾Ð²Ð¸Ñ‚ÑŒ ÐŸÑ€Ð¾Ð´Ð¾Ð»Ð¶Ð¸Ñ‚ÐµÐ»ÑŒÐ½Ð¾ÑÑ‚ÑŒ",
		"todayButtonLabel": "Ð¡ÐµÐ³Ð¾Ð´Ð½Ñ",
		"titleDateDialogLabel": "Ð’Ñ‹Ð±Ñ€Ð°Ñ‚ÑŒ Ð´Ð°Ñ‚Ñƒ",
		"titleTimeDialogLabel": "Ð’Ñ‹Ð±Ñ€Ð°Ñ‚ÑŒ Ð²Ñ€ÐµÐ¼Ñ",
		"daysOfWeek": [
		...
		"tooltip": "ÐžÑ‚ÐºÑ€Ñ‹Ñ‚ÑŒ Ð²Ñ‹Ð±Ð¾Ñ€ Ð´Ð°Ñ‚Ñ‹",
		"nextMonth": "Ð¡Ð»ÐµÐ´",
		"prevMonth": "ÐŸÑ€ÐµÐ´",
		"timeFormat": 24,
		"headerFormat": "%A, %B %-d, %Y",
		...
		"timeOutput": "%l:%M %p",
		"durationFormat": "%Dd %DA, %Dl:%DM:%DS",
		"calDateListLabel": "Ð”Ñ€ÑƒÐ³Ð¸Ðµ Ð´Ð°Ñ‚Ñ‹",
		"calHeaderFormat": "%B %Y",
		"tomorrowButtonLabel": "ÐŸÐµÑ€ÐµÐ¹Ñ‚Ð¸ Ð½Ð° Ð·Ð°Ð²Ñ‚Ñ€Ð°"
	},
	"sl": {
	...
	"sr": {
		...
		"todayButtonLabel": "Ð”Ð°Ð½Ð°Ñ",
		"titleDateDialogLabel": "Ð˜Ð·Ð°Ð±ÐµÑ€Ð¸Ñ‚Ðµ Ð´Ð°Ñ‚ÑƒÐ¼",
		"titleTimeDialogLabel": "ÐžÐ´Ð°Ð±ÐµÑ€Ð¸Ñ‚Ðµ Ð²Ñ€ÐµÐ¼Ðµ",
		"daysOfWeek": [
			"ÐÐµÐ´ÐµÑ™Ð°",
			"ÐŸÐ¾Ð½ÐµÐ´ÐµÑ™Ð°Ðº",
			"Ð£Ñ‚Ð¾Ñ€Ð°Ðº",
		...
		"tooltip": "ÐžÑ‚Ð²Ð¾Ñ€Ð¸Ñ‚Ðµ Ð¦Ð¾Ð½Ñ‚Ñ€Ð¾Ð»",
		"nextMonth": "ÑÐ»ÐµÐ´ÐµÑ›Ð¸",
		"prevMonth": "ÐŸÑ€ÐµÑ‚Ñ…Ð¾Ð´Ð½Ð°",
		"timeFormat": 24,
		"headerFormat": "%A, %B %-d, %Y",
		"dateFieldOrder": [
			"d",
		...
		"timeOutput": "%l:%M %p",
		"durationFormat": "%Dd %DA, %Dl:%DM:%DS",
		"calDateListLabel": "ÐžÑÑ‚Ð°Ð»Ð¸ Ð´Ð°Ñ‚ÑƒÐ¼Ð¸",
		"calHeaderFormat": "%B %Y",
		"tomorrowButtonLabel": "Ð¡ÐºÐ¾Ñ‡Ð¸ Ð½Ð° Ð¢Ð¾Ð¼Ð¾Ñ€Ñ€Ð¾Ð²"
	},
	"sv-SE": {
		"setDateButtonLabel": "VÃ¤lj datum",
		"setTimeButtonLabel": "VÃ¤lj tid",
		"setDurationButtonLabel": "VÃ¤lj varaktighet",
		"todayButtonLabel": "GÃ¥ till idag",
	...
	"th": {
		...
		"todayButtonLabel": "à¸à¸¥à¸±à¸šà¹„à¸›à¸§à¸±à¸™à¸™à¸µà¹‰",
		...
		"nextMonth": "à¹€à¸”à¸·à¸­à¸™à¸•à¹ˆà¸­à¹„à¸›",
		"prevMonth": "à¹€à¸”à¸·à¸­à¸™à¸à¹ˆà¸­à¸™",
		"timeFormat": 24,
		"headerFormat": "à¸§à¸±à¸™%Aà¸—à¸µà¹ˆ %-d %B %Y",
		"dateFieldOrder": [
			"d",
			"m",
			"y"
		...
		"timeOutput": "%l:%M %p",
		"durationFormat": "%Dd %DA, %Dl:%DM:%DS",
		"calDateListLabel": "à¸§à¸±à¸™à¸­à¸·à¹ˆà¸™ à¹†",
		"calHeaderFormat": "%B %Y",
		"tomorrowButtonLabel": "à¹„à¸›à¸§à¸±à¸™à¸žà¸£à¸¸à¹ˆà¸‡à¸™à¸µà¹‰"
	},
	"tr": {
		"setDateButtonLabel": "Kapat",
		"setTimeButtonLabel": "Saat ayarlama",
		"setDurationButtonLabel": "Kapat",
		"todayButtonLabel": "BugÃ¼n",
		...
		"timeOutput": "%l:%M %p",
		"durationFormat": "%Dd %DA, %Dl:%DM:%DS",
		"calDateListLabel": "DiÄŸer tarihler",
		"calHeaderFormat": "%B %Y",
		"tomorrowButtonLabel": "YarÄ±n iÃ§in atlama"
	},
	"uk": {
		"setDateButtonLabel": "Ð’ÑÑ‚Ð°Ð½Ð¾Ð²Ð¸Ñ‚Ð¸ Ð”Ð°Ñ‚Ñƒ",
		"setTimeButtonLabel": "Ð’ÑÑ‚Ð°Ð½Ð¾Ð²Ð¸Ñ‚Ð¸ Ð§Ð°Ñ",
		"setDurationButtonLabel": "Ð’ÑÑ‚Ð°Ð½Ð¾Ð²Ð¸Ñ‚Ð¸ Ð¢Ñ€Ð¸Ð²Ð°Ð»Ñ–ÑÑ‚ÑŒ",
		"todayButtonLabel": "Ð¡ÑŒÐ¾Ð³Ð¾Ð´Ð½Ñ–",
		"titleDateDialogLabel": "Ð’Ð¸Ð±Ñ€Ð°Ñ‚Ð¸ Ð´Ð°Ñ‚Ñƒ",
		...
		"tooltip": "Ð’Ñ–Ð´ÐºÑ€Ð¸Ñ‚Ð¸ ÐµÐ»ÐµÐ¼ÐµÐ½Ñ‚ Ð²Ð¸Ð±Ð¾Ñ€Ñƒ Ð´Ð°Ñ‚Ð¸",
		"nextMonth": "ÐÐ°ÑÑ‚ÑƒÐ¿Ð½Ð¾Ð³Ð¾ Ð¼Ñ–ÑÑÑ†Ñ",
		"prevMonth": "ÐœÐ¸Ð½ÑƒÐ»Ð¸Ð¹ Ð¼Ñ–ÑÑÑ†ÑŒ",
		"timeFormat": 24,
		"headerFormat": "%A, %B %-d, %Y",
		"dateFieldOrder": [
			"d",
		...
		"timeOutput": "%l:%M %p",
		"durationFormat": "%Dd %DA, %Dl:%DM:%DS",
		"calDateListLabel": "Ð†Ð½ÑˆÑ– Ð´Ð°Ñ‚Ð¸",
		"calHeaderFormat": "%B %Y",
		"tomorrowButtonLabel": "ÐŸÐµÑ€ÐµÐ¹Ñ‚Ð¸ Ð´Ð¾ Ð·Ð°Ð²Ñ‚Ñ€Ð°"
	},
	"vi": {
		...
		"tooltip": "Má»Ÿ báº£ng chá»n ngÃ y",
		"nextMonth": "Tiáº¿p",
		"prevMonth": "TrÆ°á»›c",
		"timeFormat": 24,
		"headerFormat": "%A, %B %-d, %Y",
		...
		"calHeaderFormat": "%B %Y",
		"tomorrowButtonLabel": "Nháº£y Ä‘á»ƒ ngÃ y mai"
	},
	"zh-CN": {
		"setDateButtonLabel": "è®¾ç½®æ—¥æœŸ",
		"setTimeButtonLabel": "è®¾ç½®æ—¶é—´",
		"setDurationButtonLabel": "è®¾ç½®æŒç»­æ—¶é—´",
		"todayButtonLabel": "é€‰æ‹©ä»Šå¤©æ—¥æœŸ",
		"titleDateDialogLabel": "é€‰æ‹©æ—¥æœŸ",
		...
		"timeOutput": "%l:%M %p",
		"durationFormat": "%Dd %DA, %Dl:%DM:%DS",
		"calDateListLabel": "å…¶ä»–æ—¥æœŸ",
		"calHeaderFormat": "%B %Y",
		"tomorrowButtonLabel": "è·³è½¬åˆ°æ˜Žå¤©"
	},
	"zh-TW": {
		"setDateButtonLabel": "è¨­å®šæ—¥æœŸ",
		"setTimeButtonLabel": "è¨­å®šæ™‚é–“",
		"setDurationButtonLabel": "è¨­å®šæŒçºŒæ—¥æœŸ",
		"todayButtonLabel": "é¸æ“‡ä»Šå¤©æ—¥æœŸ",
		"titleDateDialogLabel": "é¸æ“‡æ—¥æœŸ",
		"titleTimeDialogLabel": "é¸æ“‡æ™‚é–“",
		"daysOfWeek": [
