    ...
    _create: function(){
        ...
        if (o.multiselect) {
            ...
            o.select = o.select || function(e, ui) {
                var textInsert = $("#tempSearch").val();
                var textSelect = ui.item.label;
                textSelect = textSelect.replace("Buscar en","");
                $("<div></div>")
                    .addClass("ui-autocomplete-multiselect-item")
                    .text(textSelect.trim()+":"+textInsert)

                    .append($("<div name='searchOdoo' style='display:none'></div>")
                    .text(textSelect.trim()+":"+textInsert)
                    )
                    .append(
                        $("<span></span>")
