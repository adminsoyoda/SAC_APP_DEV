...
(function() {
  ...
  TextRenderer = (function() {
    ...
    TextRenderer.prototype.render = function(gauge) {
      //return this.el.innerHTML = "$" + parseInt(formatNumber(gauge.displayedValue)) + " / $" + gauge.maxValue;

      return this.el.innerHTML = "<span class='text-yellow'><strong>Cumplimiento: </strong></span><div>" + ((parseInt(formatNumber(gauge.displayedValue))*100)/ gauge.maxValue).toFixed(2) + " %</div>";     
